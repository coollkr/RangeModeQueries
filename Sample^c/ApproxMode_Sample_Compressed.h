...
class ApproxMode_Sample_Compressed{
public:
    ApproxMode_Sample_Compressed(int* array, int len, double epsilon);
    int construct();
    int findQueryResult(int start_index, int end_index);
    ~ApproxMode_Sample_Compressed();
...
private:
    ...
    rrr_vector<> **bitArray;
    rrr_vector<>::rank_1_type**  newRank;
    int *saveK;
    int *largeK;
    int* I;
