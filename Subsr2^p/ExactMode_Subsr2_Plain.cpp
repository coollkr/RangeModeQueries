...
#include "ExactMode_Subsr2_Plain.h"
#include <iostream>
...
ExactMode_Subsr2_Plain :: ExactMode_Subsr2_Plain(int* array, int len, int s) { // constructor
    this->array = array;
    this->len = len;
    this->s = s;

}
ExactMode_Subsr2_Plain :: ~ExactMode_Subsr2_Plain() { // destructor
...
void ExactMode_Subsr2_Plain :: construct() { // construct the data structure
...
pair<int, int> ExactMode_Subsr2_Plain :: findMode(int start_index, int end_index) { // find query result, return value: pair<mode, frequency>, parameter: left index of query and right index of query
    pair<int, int> res;
...
pair<int, int> ExactMode_Subsr2_Plain :: Third_Method(int start_index, int end_index) {  // third method part, return value <mode, frequency>, parameter: left index of query and right index of query
    pair<int, int> res;
...
pair<int, int> ExactMode_Subsr2_Plain :: bitMethod(int start_index, int end_index, int s, int t) { // bit method part, return value <mode, frequency>, parameter: left index of query and right index of query
...
int ExactMode_Subsr2_Plain :: getCandidateFreq(int len, int freq_c, int x, int i, int j) {  // get the frequency of current candidate, return the frequency of current value -> x in the range from i to j. i: left index, j: right index.
    int currentKey = 0;
...
int ExactMode_Subsr2_Plain :: getSuffixCandidateFreq(int len, int freq_c, int x, int i, int j) {// get the frequency of current candidate in the suffix , return the frequency of current value -> x in the range from i to j. i: left index, j: right index.
    int currentKey = 0;
...
void ExactMode_Subsr2_Plain :: update_Ci_Table(int numOfBlocks) {  // update Ci table
...
long long ExactMode_Subsr2_Plain :: get1DSize (size_t byte, int row) { // calculate the space usage of 1d array, return value is the space, para: size unit, the number of unit
    long long space = 0;
    space = byte * row;
    return space;
}
long long ExactMode_Subsr2_Plain :: get2DSize (size_t byte, int row, int col) {// calculate the space usage of 2d array, return value is the space, para: size unit, the number of unit in row and col
    long long space = 0;
    space = byte * row * col;
    return space;
}