/*
 * It is the main.cpp file to run the subsr^2_c data structure
 */
...
void queryExperiment(ExactMode_Subsr2_Compressed *exactMode_Rrr_CDLMW);
...
int main() {
    ...
    ExactMode_Subsr2_Compressed *exactMode_Rrr_CDLMW = new ExactMode_Subsr2_Compressed(array, len, s);
