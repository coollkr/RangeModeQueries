/*
 * It is the main.cpp file to run the succ^p data structure
 */
#include <iostream>
...
void queryExperiment(ApproxMode_Succ_Plain *approximateMode_Bit_EHMNS, int delta, int** Qa, int* QaSize);
...
int main() {
    ...
    ApproxMode_Succ_Plain *approximateMode_Bit_EHMNS = new ApproxMode_Succ_Plain(array, len, epsilon);
...
void queryExperiment(ApproxMode_Succ_Plain *approximateMode_Bit_EHMNS, int delta, int** Qa, int* QaSize) {
    ...
    ofstream moderesult("/users/grad/liu1/data_park/HeplusBitMode.txt");
