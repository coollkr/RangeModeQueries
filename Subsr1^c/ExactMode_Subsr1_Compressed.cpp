...
#include "ExactMode_Subsr1_Compressed.h"
#include <iostream>
...
ExactMode_Subsr1_Compressed :: ExactMode_Subsr1_Compressed(int* array, int len, int s) { // constructor
    this->array = array;
    this->len = len;
    this->s = s;

}
ExactMode_Subsr1_Compressed :: ~ExactMode_Subsr1_Compressed() { // destructor
...
void ExactMode_Subsr1_Compressed :: construct() { // construct the data structure
...
pair<int, int> ExactMode_Subsr1_Compressed :: findMode(int start_index, int end_index) { // find query result, return value: pair<mode, frequency>, parameter: left index of query and right index of query
    pair<int, int> res;
...
pair<int, int> ExactMode_Subsr1_Compressed :: Third_Method(int start_index, int end_index) {  // third method part, return value <mode, frequency>, parameter: left index of query and right index of query
    pair<int, int> res;
...
pair<int, int> ExactMode_Subsr1_Compressed :: bitMethod(int start_index, int end_index, int s, int t) { // bit method part, return value <mode, frequency>, parameter: left index of query and right index of query
...
int ExactMode_Subsr1_Compressed :: getCandidateFreq(int len, int freq_c, int x, int i, int j) {  // get the frequency of current candidate, return the frequency of current value -> x in the range from i to j. i: left index, j: right index.
    int currentKey = 0;
...
int ExactMode_Subsr1_Compressed :: getSuffixCandidateFreq(int len, int freq_c, int x, int i, int j) {// get the frequency of current candidate in the suffix , return the frequency of current value -> x in the range from i to j. i: left index, j: right index.
    int currentKey = 0;
...
void ExactMode_Subsr1_Compressed :: update_Ci_Table(int numOfBlocks) {  // update Ci table
...
long long ExactMode_Subsr1_Compressed :: get1DSize (size_t byte, int row) { // calculate the space usage of 1d array, return value is the space, para: size unit, the number of unit
    long long space = 0;
    space = byte * row;
    return space;
}
long long ExactMode_Subsr1_Compressed :: get2DSize (size_t byte, int row, int col) {// calculate the space usage of 2d array, return value is the space, para: size unit, the number of unit in row and col
    long long space = 0;
    space = byte * row * col;
    return space;
}
