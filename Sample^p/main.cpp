/*
 * It is the main.cpp file to run the sample^p data structure
 */
#include <iostream>
...
void queryExperiment(ApproxMode_Sample_Plain *approximateMode_Bit_GJLT, int delta, int** Qa, int* QaSize);
...
int main() {
    ...
    ApproxMode_Sample_Plain *approximateMode_Bit_GJLT = new ApproxMode_Sample_Plain(array, len, epsilonPrime);
    ...
    int t = approximateMode_Bit_GJLT->construct();
    ...
    queryExperiment(approximateMode_Bit_GJLT, delta, Qa, QaSize);


    delete approximateMode_Bit_GJLT;
    delete[] array;
    return 0;
}
void queryExperiment(ApproxMode_Sample_Plain *approximateMode_Bit_GJLT, int delta, int** Qa, int* QaSize) {
    ...
    cout << endl;
    ofstream moderesult("/users/grad/liu1/data_park/1plusBitMode.txt");
    //ofstream moderesult("/users/grad/liu1/1plusBitMode.txt");
