/*
 * It is the main.cpp file to run the subsr^2_p data structure
 */
...
void queryExperiment(ExactMode_Subsr2_Plain *exactMode_CDLMW);
...
int main() {
    ...
    ExactMode_Subsr2_Plain *exactMode_Bit_CDLMW = new ExactMode_Subsr2_Plain(array, len, s);
...
void queryExperiment(ExactMode_Subsr2_Plain *exactMode_Bit_CDLMW) {
    int start_index = 0;
    int end_index = 0;
    ...
    ofstream integrated_result("/users/grad/liu1/data_text/BitTimothyResult2_book_1000.txt");
